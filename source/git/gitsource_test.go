...
// TestValidateDirsOnly_CVE_2026_33748 verifies that subdir path traversal and
// symlink escapes are blocked (CVE-2026-33748).
func TestValidateDirsOnly_CVE_2026_33748(t *testing.T) {
	if runtime.GOOS == "windows" {
